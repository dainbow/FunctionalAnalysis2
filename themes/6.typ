...
#proof[
  ...
  Отсюда $norm(x_n)$ и $A x_n = lambda x_n$. Более того, $seq(x)$ -- ограниченное
...
#proof[
  ...
  Пусть $e_n$ -- нормированный собственный вектор для значения $lambda_n$. Тогда $seq(e)$ -- огрениченное
...
#proof[
  Построим нужный базис явным образом. Для этого упорядочим все собственные значения оператора $A$ по модулю, причём включим в этот ряд компии этих значений столько раз, сколько соответствует размерности их собственного подпространства (в силу теоремы о конечности размерности собственных подпространств, это возможно). Получим ряд:
  #eq[
